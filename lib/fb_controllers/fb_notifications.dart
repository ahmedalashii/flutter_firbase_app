...
mixin FirebaseNotifications {
  ...
  static Future<void> initNotifications() async {
    ...
    // Channel
    if (!kIsWeb) {       // are you not web ?
      channel = const AndroidNotificationChannel( // every app has its own channel/s.
    ...
    // Flutter Local Notifications Plugin (FOREGROUND) - ANDROID CHANNEL >> Foreground means visible on the screen ..
